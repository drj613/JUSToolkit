...
Deep dive analysis mapping Gotenks SSJ through all data files to understand linkages.
...
**IMPORTANT NOTE:** Gotenks SSJ has charId=54, which is DIFFERENT from base Gotenks
(charId=7). This suggests SSJ form uses a completely different stat template.
...
This suggests Gotenks SSJ uses a completely different stat template than his base form,
possibly to represent his powered-up state with different attack/defense ratios.
...
- This suggests 3 normal attacks (7 damage each) and one stronger attack (28 damage)

**Characters sharing Block 4:**

- db_b_09 (Gotenks SSJ) - chr_b[8], classId=516 (ONLY character in this block)

**Note:** Gotenks SSJ has his own unique jpower block (4), not shared with any other
character. This is unusual compared to other Dragon Ball characters who often share blocks.
...
3. Is Block 4 exclusively for Gotenks SSJ or are there other characters we haven't mapped?
...
- The charId=54 group includes diverse characters (Frieza, Dio, Kakashi) - likely
  represents a specific stat archetype rather than series grouping
