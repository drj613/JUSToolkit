...
**Start here for new sessions.** This is the entrypoint for understanding the reverse engineering research.
...
We use [beads](https://github.com/steveyegge/beads) for persistent issue tracking.
